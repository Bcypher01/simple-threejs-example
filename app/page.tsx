        ...
        <div className="w-full md:w-1/3 p-4 bg-slate-50 dark:bg-slate-900 overflow-y-auto">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Learn Three.js by experimenting with different parameters
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                <TabsContent value="basics" className="space-y-4">
                  ...
                  <div className="bg-slate-100 dark:bg-slate-800 p-4 rounded-md">
                    ...
                    <p className="text-sm">
                      The scene contains a 3D object that rotates. The rotation
                      speed is controlled by the slider above. The wireframe
                      shows the underlying structure of the 3D model.
                    </p>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="geometry" className="space-y-4">
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <Button
                        variant={geometry === "box" ? "default" : "outline"}
                      ...
                      <Button
                        variant={
                          geometry === "icosahedron" ? "default" : "outline"
                        }
                  ...
                  <div className="bg-slate-100 dark:bg-slate-800 p-4 rounded-md">
                    ...
                    <p className="text-sm">
                      Three.js provides many built-in geometry types. Each
                      geometry is defined by vertices (points), edges (lines),
                      and faces (surfaces). The icosahedron in your original
                      code is a 20-sided polyhedron.
                    </p>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="lighting" className="space-y-4">
                  ...
                  <div className="bg-slate-100 dark:bg-slate-800 p-4 rounded-md">
                    ...
                    <p className="text-sm">
                      Your original code uses a HemisphereLight, which provides
                      ambient light from above and below. The color you select
                      affects the top hemisphere of the light. Lighting is
                      crucial for creating realistic 3D scenes and making
                      objects visible.
                    </p>
                  </div>
                </TabsContent>
